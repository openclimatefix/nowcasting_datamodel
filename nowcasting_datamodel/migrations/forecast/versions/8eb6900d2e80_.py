...
def upgrade():  # noqa
    ...
    op.create_index(
        op.f("ix_forecast_value_latest_forecast_id"),
        "forecast_value_latest",
        ["forecast_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_forecast_value_latest_gsp_id"), "forecast_value_latest", ["gsp_id"], unique=False
    )
    op.create_index(
        op.f("ix_forecast_value_latest_target_time"),
        "forecast_value_latest",
        ["target_time"],
        unique=False,
    )
